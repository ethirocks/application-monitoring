...
@Component({
  selector: 'app-war-network',
  templateUrl: './war-network.component.html',
  styleUrls: ['./war-network.component.css']
})
export class WarNetworkComponent implements OnInit {
  ...
  refreshData() {
    ...
    //    //console.log(this.lineChartData);
       ...
       this.atService.getDetails("warNetworkMetrics",this.userID,this.appID).subscribe(function (data1) { 
               ...
               e.values.map(function(eachValueArray) {
                 ...
                 eachValueArray.map(function(value, index) {
                    ...
                    //  u.length = 0
                     ...
                     console.log(u.length, "this is x axis")
                     // this.ud.push(value)
                     ...
                     //console.log(value,"bta bhai");
                      ...
                      console.log(z.length, "OOOOOOOOOOOOO")
                    }
