...
@Component({
  selector: 'app-war-memory',
  templateUrl: './war-memory.component.html',
  styleUrls: ['./war-memory.component.css']
})
export class WarMemoryComponent implements OnInit {
  ...
  refreshData() {
    ...
    this.atService.getDetails("warMemory",this.userID,this.appID).subscribe(function (data1) { 
      console.log("ud"+ a);
      this.data = data1
