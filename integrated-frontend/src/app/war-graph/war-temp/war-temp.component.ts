...
@Component({
  selector: 'app-war-temp',
  templateUrl: './war-temp.component.html',
  styleUrls: ['./war-temp.component.css']
})
export class WarTempComponent implements OnInit {
  ...
  refreshData() {
    ...
    this.atService.getDetails("warCpuTemp",this.userID,this.appID).subscribe(function (data1) { 
      //console.log("ud"+ a);
      this.data = data1
      //  console.log(JSON.stringify(dat))
      //console.log(data1.results.length)
