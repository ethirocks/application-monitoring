...
@Component({
  ...
  templateUrl: './cpu-cores-stat.component.html',
  styleUrls: ['./cpu-cores-stat.component.css']
})
export class CpuCoresStatComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.atService.getStatic(this.date,this.date1,this.from,this.to,"cpuCores").subscribe((data:any) =>{ this.container = data
