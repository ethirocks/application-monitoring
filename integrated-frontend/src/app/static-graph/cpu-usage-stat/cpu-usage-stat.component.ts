...
@Component({
  ...
  templateUrl: './cpu-usage-stat.component.html',
  styleUrls: ['./cpu-usage-stat.component.css'],
  
})
export class CpuUsageStatComponent implements OnInit{
...
//      return h + ':' + m;
    ...
    //  this.lineChartLabels = a;
     ...
     this.atService.getStatic(this.date,this.date1,this.from,this.to,"cpuusage").subscribe(function (data2) { 
      //console.log("ud"+ a);
      this.data = data2
      //  console.log(JSON.stringify(dat))
