...
@Component({
  selector: 'app-http',
  templateUrl: './http-stat.component.html',
  styleUrls: ['./http-stat.component.css']
})
export class HttpStatComponent implements OnInit {
...
//   refreshData() {
    ...
    this.atService.getStatic(this.date,this.date1,this.from,this.to,"http_requests").subscribe(function (data8) { 
      //console.log("ud"+ a);
      this.data = data8
