...
public class ThreadJob implements Job {
    ...
    @Autowired
    public ThreadJob(KafkaTemplate<String, KafkaDomain> kafkaTemplate) {
        if (ThreadJob.kafkaTemplate == null) {
            ThreadJob.kafkaTemplate = kafkaTemplate;
            ThreadJob.TOPIC="thread";
        }
    }
