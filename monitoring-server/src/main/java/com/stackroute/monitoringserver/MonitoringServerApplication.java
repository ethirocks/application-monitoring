...
//        containerConsumer.start();
        ...
        healthPoll.setTimerTask(healthConsumer,"http://10.20.1.218:8082");
...
//        diskPoll.start(20000);
        ...
        cpuUsagePoll.setTimerTask(cpuUsageConsumer,"http://10.20.1.218:8082");
        ...
        cpuTempPoll.setTimerTask(cpuTempConsumer,"http://10.20.1.218:8082");
...
//
        ...
        threadPoll.setTimerTask(threadConsumer,"http://10.20.1.218:8082");
